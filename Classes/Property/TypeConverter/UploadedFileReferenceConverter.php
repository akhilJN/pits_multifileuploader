<?php
namespace PMFU\PitsMultifileuploader\Property\TypeConverter;
...
class UploadedFileReferenceConverter extends AbstractTypeConverter {
	...
	protected function importUploadedResource(array $uploadInfo, PropertyMappingConfigurationInterface $configuration) {
		...
		$allowedFileExtensions = $configuration->getConfigurationValue('PMFU\\PitsMultifileuploader\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_ALLOWED_FILE_EXTENSIONS);
		...
		$uploadFolderId = $configuration->getConfigurationValue('PMFU\\PitsMultifileuploader\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_UPLOAD_FOLDER) ?: $this->defaultUploadFolder;
		$conflictMode = $configuration->getConfigurationValue('PMFU\\PitsMultifileuploader\\Property\\TypeConverter\\UploadedFileReferenceConverter', self::CONFIGURATION_UPLOAD_CONFLICT_MODE) ?: $this->defaultConflictMode;
	 ...
	 * @return \PMFU\PitsMultifileuploader\Domain\Model\FileReference
	 */
	...
	protected function createFileReferenceFromFalFileReferenceObject(FalFileReference $falFileReference, $resourcePointer = NULL) {
		if ($resourcePointer === NULL) {
			/** @var $fileReference \PMFU\PitsMultifileuploader\Domain\Model\FileReference */
